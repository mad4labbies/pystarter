...
files = StringVar(value=dir_files)
...
menubar.add_cascade(menu=menu_file, label='File',background='yellow')
...
menu_help.add_command(label='About', command=exitProgram,background='yellow')
...
lbox = Listbox(c, listvariable=files, height=5,width=35)
...
status.grid(column=0, row=7, columnspan=3, sticky=(W,E))
...
status.configure(background='#f0f0ff')
