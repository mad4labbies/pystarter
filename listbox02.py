...
menubar.add_cascade(menu=menu_file, label='File',background='yellow',foreground='red')
menubar.add_cascade(menu=menu_edit, label='Edit',background='yellow',foreground='red')
...
status.grid(column=0, row=6, columnspan=3, sticky=(W,E))
